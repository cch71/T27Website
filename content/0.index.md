...
#default
  ...
  Troop 27 Sign-ups
  #description
  [11-07 WeBeLos Invitational Campout Signup](https://forms.gle/ybcdQqVWEcVSKdAr7){target="_blank"}
  ::
  ...
  ::card
  #title
  Summer Camp @ Camp Daniel Boone
  #description
  <iframe src="https://bsatroop27.smugmug.com/frame/slideshow?key=rG84zh&speed=2&transition=fade&autoStart=1&captions=0&navigation=0&playButton=0&randomize=1&transitionSpeed=1&clickable=1" width="240" height="240" frameborder="no" scrolling="no"></iframe>
  ::
  ...
  Northern Tier
  #description
  <iframe src="https://bsatroop27.smugmug.com/frame/slideshow?key=vHqkPN&speed=2&transition=fade&autoStart=1&captions=0&navigation=0&playButton=0&randomize=1&transitionSpeed=1&clickable=1" width="240" height="240" frameborder="no" scrolling="no"></iframe>
  ::
::
